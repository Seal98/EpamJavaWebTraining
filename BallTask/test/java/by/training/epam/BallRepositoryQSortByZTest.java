...
import by.training.epam.repository.BallsZPointComparator;

public class BallRepositoryQSortByZTest {

	@Test
	public void sortBallsByZTest() throws FigureAlreadyExistException {
		...
		rep.addFigure(ball4);
		rep.addFigure(ball3);
		rep.sortBalls(new BallsZPointComparator());
